    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 sm:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mb-8 text-pretty max-w-2xl mx-auto">
                This is a structured, $75/month mentorship built for traders who want implementation support, clearer
                routines, and honest feedback. It is not a signals group and does not promise results.
              </p>
          ...
          <div className="container px-4 sm:px-6">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              ...
              <div className="flex items-start gap-3 text-sm">
                <Check className="w-5 h-5 text-primary flex-shrink-0" />
                <div>
                  <p className="font-semibold text-foreground">Access to validated models</p>
                  <p className="text-muted-foreground">
              ...
              <div className="flex items-start gap-3 text-sm">
                <Check className="w-5 h-5 text-primary flex-shrink-0" />
                <div>
                  <p className="font-semibold text-foreground">Live execution examples with reasoning</p>
                  <p className="text-muted-foreground">
              ...
              <div className="flex items-start gap-3 text-sm">
                <Check className="w-5 h-5 text-primary flex-shrink-0" />
                <div>
                  <p className="font-semibold text-foreground">Trade reviews and accountability</p>
                  <p className="text-muted-foreground">
        ...
        <section className="py-12 sm:py-16 border-t border-border bg-muted/30">
          <div className="container px-4 sm:px-6">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-6">Cancel anytime. This is a selective program.</p>
              <Button size="lg" className="gap-2 w-full sm:w-auto">
                Apply for Mentorship
              </Button>
            </div>
        ...
        <section className="py-12 sm:py-16 border-t border-border">
          <div className="container px-4 sm:px-6">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-4">Risk disclaimer</h2>
              <p className="text-sm text-muted-foreground">
                ...
                of performance. You are responsible for your own decisions and risk management.
              </p>
            </div>
          </div>
        </section>
