    ...
    items: [
      {
        ...
        notFor: "Anyone still changing strategies or violating daily loss limits.",
      ...
      <main className="flex-1">
        <div className="container px-4 sm:px-6 py-8 sm:py-12 max-w-5xl mx-auto">
          ...
          <div className="mt-12 border-t border-border pt-6 text-sm text-muted-foreground">
            Affiliate disclosure: Some links may be affiliate links. If you use them, we may earn a commission at no
            extra cost to you.
          </div>
        </div>
      </main>
